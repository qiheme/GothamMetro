...
RSpec.describe FaresController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all fares as @fares" do
      ...
      expect(assigns(:fares)).to eq([fare])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new fare as @fare" do
      ...
      expect(assigns(:fare)).to be_a_new(Fare)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Fare" do
        expect {
          post :create, {:fare => valid_attributes}, valid_session
        }.to change(Fare, :count).by(1)
      end

      it "assigns a newly created fare as @fare" do
        post :create, {:fare => valid_attributes}, valid_session
        expect(assigns(:fare)).to be_a(Fare)
        expect(assigns(:fare)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved fare as @fare" do
        post :create, {:fare => invalid_attributes}, valid_session
        expect(assigns(:fare)).to be_a_new(Fare)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested fare" do
        fare = Fare.create! valid_attributes
        put :update, {:id => fare.to_param, :fare => new_attributes}, valid_session
        fare.reload
      ...
      it "assigns the requested fare as @fare" do
        fare = Fare.create! valid_attributes
        put :update, {:id => fare.to_param, :fare => valid_attributes}, valid_session
        expect(assigns(:fare)).to eq(fare)
      end
    ...
    describe "with invalid params" do
      it "assigns the fare as @fare" do
        fare = Fare.create! valid_attributes
        put :update, {:id => fare.to_param, :fare => invalid_attributes}, valid_session
        expect(assigns(:fare)).to eq(fare)
      end
