...
RSpec.describe ShapesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all shapes as @shapes" do
      ...
      expect(assigns(:shapes)).to eq([shape])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested shape as @shape" do
      ...
      expect(assigns(:shape)).to eq(shape)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new shape as @shape" do
      ...
      expect(assigns(:shape)).to be_a_new(Shape)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created shape as @shape" do
        post :create, {:shape => valid_attributes}, valid_session
        expect(assigns(:shape)).to be_a(Shape)
        expect(assigns(:shape)).to be_persisted
      end

      it "redirects to the created shape" do
        post :create, {:shape => valid_attributes}, valid_session
        expect(response).to redirect_to(Shape.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved shape as @shape" do
        post :create, {:shape => invalid_attributes}, valid_session
        expect(assigns(:shape)).to be_a_new(Shape)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested shape" do
        shape = Shape.create! valid_attributes
        put :update, {:id => shape.to_param, :shape => new_attributes}, valid_session
        shape.reload
    ...
    describe "with invalid params" do
      it "assigns the shape as @shape" do
        shape = Shape.create! valid_attributes
        put :update, {:id => shape.to_param, :shape => invalid_attributes}, valid_session
        expect(assigns(:shape)).to eq(shape)
      end
